...
public class LoadingStateOverlay {
    public void render(GuiGraphics guiGraphics, int screenWidth, int screenHeight) {
        ...
        // stubbed localPlayer, ExtraPlayerRenderConfig.PLAYER_POS_X, ExtraPlayerRenderConfig.PLAYER_POS_Y, ExtraPlayerRenderConfig.PLAYER_SCALE, ExtraPlayerRenderConfig.PLAYER_YAW_OFFSET, -500, minecraft.getFrameTime());
    }
}
