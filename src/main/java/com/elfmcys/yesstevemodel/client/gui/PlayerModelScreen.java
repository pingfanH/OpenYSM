...
public class PlayerModelScreen extends Screen implements IGuiWidget {
    ...
    public void renderModelPreview(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (localPlayer != null) {
            ...
            InventoryScreen.renderEntityInInventory(guiGraphics, this.guiLeft + 67, this.guiTop + 190, 70, (float)(float)((this.guiLeft + 67) - mouseX), (float)(float)(((this.guiTop + 180) - 95) - mouseY), localPlayer);
            guiGraphics.pose().popPose();
